...
public class AudioPlayerManager extends Service {
    ...
    // Intent Actions
    public static final String ACTION_PLAY = "com.pipixia.PLAY";
    public static final String ACTION_PAUSE = "com.pipixia.PAUSE";
    public static final String ACTION_NEXT = "com.pipixia.NEXT";
    public static final String ACTION_CLEAR = "com.pipixia.CLEAR";
    public static final String ACTION_ADD_TO_PLAYLIST = "com.pipixia.ADD_TO_PLAYLIST";
    public static final String ACTION_SET_PLAYLIST = "com.pipixia.SET_PLAYLIST";
